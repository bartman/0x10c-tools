...
struct x10c_isn x10c_basic_isns[X10C_OP_MAX] = {
	...
	X10C_BASIC_ISN_ENTRY(MLI),
	X10C_BASIC_ISN_ENTRY(DIV),
	X10C_BASIC_ISN_ENTRY(DVI),
	X10C_BASIC_ISN_ENTRY(MOD),
	X10C_BASIC_ISN_ENTRY(MDI),
	X10C_BASIC_ISN_ENTRY(AND),
	X10C_BASIC_ISN_ENTRY(BOR),
	X10C_BASIC_ISN_ENTRY(XOR),
	X10C_BASIC_ISN_ENTRY(SHR),
	X10C_BASIC_ISN_ENTRY(ASR),
	X10C_BASIC_ISN_ENTRY(SHL),
	X10C_BASIC_ISN_ENTRY(IFB),
	X10C_BASIC_ISN_ENTRY(IFC),
	X10C_BASIC_ISN_ENTRY(IFE),
	X10C_BASIC_ISN_ENTRY(IFN),
	X10C_BASIC_ISN_ENTRY(IFG),
	X10C_BASIC_ISN_ENTRY(IFA),
	X10C_BASIC_ISN_ENTRY(IFL),
	X10C_BASIC_ISN_ENTRY(IFU),
	X10C_BASIC_ISN_ENTRY(ADX),
	X10C_BASIC_ISN_ENTRY(SBX),
	X10C_BASIC_ISN_ENTRY(STI),
	X10C_BASIC_ISN_ENTRY(STD),
};

/* special operation handling */

#define X10C_SPECIAL_ISN_ENTRY(OP) \
...
struct x10c_isn x10c_non_basic_isns[X10C_XOP_MAX] = {
	X10C_SPECIAL_ISN_ENTRY(JSR),
	X10C_SPECIAL_ISN_ENTRY(HCF),
	X10C_SPECIAL_ISN_ENTRY(INT),
	X10C_SPECIAL_ISN_ENTRY(IAG),
	X10C_SPECIAL_ISN_ENTRY(IAS),
	X10C_SPECIAL_ISN_ENTRY(RFI),
	X10C_SPECIAL_ISN_ENTRY(IAQ),
	X10C_SPECIAL_ISN_ENTRY(HWN),
	X10C_SPECIAL_ISN_ENTRY(HWQ),
	X10C_SPECIAL_ISN_ENTRY(HWI),
};
